...
//! ```
//!
//! Each tile is a gzip-compressed SRTM1 HGT file (3601 x 3601 x 2 bytes)
//! covering one 1x1 degree cell, named after its SW corner: `N48W123.hgt.gz`.
...
/// Return all 1x1 degree tile SW corners needed to cover (`min_lat`, `min_lon`) -
/// (`max_lat`, `max_lon`).
///
...
/// If any tile fails all retries the function returns an error.
///
